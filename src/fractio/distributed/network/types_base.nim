# Network Types - Message types and wire protocol definitions (declarative)
...
# The helper procs are in types.nim which imports this file.

import ../../core/types
from ../raft/group_types import GroupID, groupIDToULID, groupIDFromULID,
    ZeroGroupID

# Re-export types needed by message definitions and downstream consumers
export NodeID, ULID, ZeroULID, GroupID, groupIDToULID, groupIDFromULID, ZeroGroupID
