...
proc setupRaftNode*(server: ProtocolServer, raftPort: int,
  ...
  let coord = newNuRaftCoordinator(nuraft_coordinator.CoordinatorConfig(
    ...
    host: server.config.host,
    dataDir: raftDir,
    # Use 0 to trigger defaults in nuraft_coordinator (500/1000ms with 100ms heartbeat)
    # Hardcoding 300/600ms here caused massive term bouncing and META group instability
    electionTimeoutLowerMs: 0,
    electionTimeoutUpperMs: 0,
