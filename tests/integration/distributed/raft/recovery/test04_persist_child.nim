# Recovery Test 4 - Step 1: Create persistent data
# Run before 04_persist_parent.nim
...
let idx = raftNode.commit("persistent data")
if idx != 1:
  echo "FAIL: Expected idx=1, got ", idx
  quit(1)

echo "Child: committed persistent data"
raftNode.shutdown()
echo "OK: Persistent data created"
