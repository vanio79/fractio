# Recovery Test 5 - Step 1: Create crash data
# Run before 05_crash_parent.nim
...
let idx = raftNode.commit("crash-data")
if idx != 1:
  echo "FAIL: Expected idx=1, got ", idx
  quit(1)

echo "Child: committed crash data"
raftNode.shutdown()
echo "OK: Crash data created"
